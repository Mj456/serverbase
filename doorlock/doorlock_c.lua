...
Citizen.CreateThread(function()
    while true do
        ...
        for i = 1, #doorList do
            ...
            local playerDistance = Vdist(playerCoords.x, playerCoords.y, playerCoords.z, doorList[i]["x"], doorList[i]["y"], doorList[i]["z"], true)
            ...
            if(playerDistance < 1.25) then
                ...
                if IsCop and IsControlJustPressed(1,38) then                                       
                    if doorList[i]["locked"] == true then
...
doorList = {
    ...
    [15] = { ["objName"] = "v_ilev_shrfdoor", ["x"]= 1855.105, ["y"]= 3683.516,["z"]= 34.266,["locked"]= false,["txtX"]=1854.605,["txtY"]=3683.516,["txtZ"]=34.30},
